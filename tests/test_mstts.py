...
from mstts.speech_synthesis import configure_speech_synthesizer, synthesize_speech
...
def test_speech_synthesis():
    ...
    # 配置语音合成器
    speech_config = configure_speech_synthesizer(subscription, region)
    
    # 设置输出文件
    output_file = os.path.join(os.path.dirname(__file__), "test_output.mp3")
    
    # 合成语音
    success = synthesize_speech(test_text, output_file, speech_config)
